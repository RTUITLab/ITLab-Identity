...
using ITLab.Identity.STS.Identity.Configuration.ApplicationParts;
using ITLab.Identity.STS.Identity.Configuration.Constants;
using ITLab.Identity.STS.Identity.Configuration.Interfaces;
using ITLab.Identity.STS.Identity.Helpers.Localization;
using ITLab.Identity.STS.Identity.Services;
using System.Linq;
